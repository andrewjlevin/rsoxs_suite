...
num_fibrils = 1
length = 2000
total_diameters = [200, 250, 300, 350, 400, 450, 500, 550, 600, 650]
fuzz_lengths = [10, 15]
flexes = [0.0001]
e_dens = 0.00001
fuzz_dens = 0.0001
    ...
    for total_diameter in total_diameters:
        for fuzz_length in fuzz_lengths:
            ...
            test_fibril_scattering_par(
                ...
                savepath + 'fuzzfibril_oct/' + f'dtotal{total_diameter}_length{length}_flex{flex_label}_fuzz{fuzz_length}_fuzzdens10to1/'
                )