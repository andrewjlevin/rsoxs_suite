...
num_fibrils = 1
length = 2000
total_diameters = np.arange(50,1050,50)
fuzz_lengths = [5, 7, 10, 15, 20, 30]
flex = 0.0001
e_dens = 0.00001
fuzz_denses = [0.00005, 0.00002, 0.000015, 0.00001]
q_norm_idx = 9

flexes_dict = {0.05:'0p05', 0.01:'0p01', 0.001:'0p001', 0.0001:'0p0001'}
fuzz_dens_dict = {0.00005:'5to1', 0.00002:'2to1', 0.000015:'1p5to1', 0.00001:'1to1'}
for fuzz_dens in fuzz_denses:
    for total_diameter in total_diameters:
        for fuzz_length in fuzz_lengths:
            ...
            fuzz_dens_label = fuzz_dens_dict[fuzz_dens]
            test_fibril_scattering_par(
                num_fibrils, length, diameter, flex, e_dens,fuzz_dens, fuzz_length, q_norm_idx, exp_path,
                savepath + 'fuzzfibril_oct_3/' + f'dtotal{total_diameter}_length{length}_flex{flex_label}_fuzz{fuzz_length}_fuzzdens{fuzz_dens_label}/'
                )